import os
import urllib.error
from tkinter import Button, StringVar, Entry, Label, E, W, Tk, HORIZONTAL, mainloop, messagebox, filedialog
from tkinter.ttk import Progressbar
from urllib.request import urlretrieve

"""
    Small GUI program to bulk download images from an MLS listing
"""


# this uses global variables to keep track of the MLS number and folder path which is kind of gross but it's a
# good enough solution that doesn't introduce bugs for what is a relatively small and simple program
...
def download():
    ...
    if folder_path.get() == "" or folder_path.get() is None:
        messagebox.showinfo("Error", "Choose a download folder")
    elif MLS.get() == "" or MLS.get() is None:
